...
/***/ "./js/modules/init-cube-animation.js":
/*!*******************************************!*\
  !*** ./js/modules/init-cube-animation.js ***!
  \*******************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initCubeAnimation: function() { return /* binding */ initCubeAnimation; }
/* harmony export */ });
var initCubeAnimation = function initCubeAnimation() {
  var wrapper = document.querySelector('[data-cube-wrapper]');
  if (!wrapper) {
    return;
  }
  var cube = wrapper.querySelector('[data-cube]');
  var buttonLeft = wrapper.querySelector('[data-button-left]');
  var buttonRight = wrapper.querySelector('[data-button-right]');
  var windowWidth = window.screen.width - cube.offsetWidth;
  var currentPosition = windowWidth;
  buttonLeft.addEventListener('click', function (evt) {
    ...
    animation({
      ...
      draw: function draw(progress) {
        cube.style.transform = "translateX(".concat(windowWidth - progress * windowWidth, "px) rotate(").concat(progress * 360, "deg");
  ...
  buttonRight.addEventListener('click', function (evt) {
    ...
    animation({
      ...
      draw: function draw(progress) {
        cube.style.transform = "translateX(".concat(progress * windowWidth, "px) rotate(").concat(progress * 360, "deg)");
  ...
  window.onresize = function () {
    if (currentPosition > 0) {
      ...
      cube.style.transform = "translateX(".concat(currentPosition, "px)");
    }
  };
};
...
/* harmony import */ var _modules_init_cube_animation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-cube-animation */ "./js/modules/init-cube-animation.js");
...
window.addEventListener('DOMContentLoaded', function () {
  window.addEventListener('load', function () {
    ...
    (0,_modules_init_cube_animation__WEBPACK_IMPORTED_MODULE_6__.initCubeAnimation)();
  });
});
}();
/******/ })()
